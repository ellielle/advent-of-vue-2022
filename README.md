This repo is a collection of my solutions for the [Advent of Vue](https://adventofvue.com/) challenges. Each solution is in it's own branch, with `main` being day 1.
